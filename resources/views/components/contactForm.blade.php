              ...
              <div class="grid gap-4 lg:gap-8">
                ...
                <div class="grid grid-cols-1 sm:grid-cols-2 gap-4">
                  <div>
                    ...
                    <input type="text" name="hs-firstname-contacts-1" id="hs-firstname-contacts-1" class="py-3 px-4 block mb-2 w-full outline-none border-2 border-[#264143] shadow-[3px_4px_0px_1px_#E99F4C]  rounded-md text-sm focus:translate-y-1 focus:shadow-[1px_2px_0px_0px_#E99F4C]" placeholder="First Name">
                  </div>
    
                  <div>
                    <label for="hs-lastname-contacts-1" class="sr-only">Last Name</label>
                    <input type="text" name="hs-lastname-contacts-1" id="hs-lastname-contacts-1" class="py-3 px-4 block mb-2 w-full outline-none border-2 border-[#264143] shadow-[3px_4px_0px_1px_#E99F4C]  rounded-md text-sm focus:translate-y-1 focus:shadow-[1px_2px_0px_0px_#E99F4C]" placeholder="Last Name">
                  </div>
                </div>
                <!-- End Grid -->
                ...
                <div>
                  ...
                  <input type="email" name="hs-email-contacts-1" id="hs-email-contacts-1" autocomplete="email" class="py-3 px-4 block mb-2 w-full outline-none border-2 border-[#264143] shadow-[3px_4px_0px_1px_#E99F4C]  rounded-md text-sm focus:translate-y-1 focus:shadow-[1px_2px_0px_0px_#E99F4C] " placeholder="Email">
                </div>
    
                <div>
                  <label for="hs-phone-number-1" class="sr-only">Phone Number</label>
                  <input type="text" name="hs-phone-number-1" id="hs-phone-number-1" class="py-3 px-4 block mb-2 w-full outline-none border-2 border-[#264143] shadow-[3px_4px_0px_1px_#E99F4C]  rounded-md text-sm focus:translate-y-1 focus:shadow-[1px_2px_0px_0px_#E99F4C]" placeholder="Phone Number">
                </div>
    
                <div>
                  <label for="hs-about-contacts-1" class="sr-only">Details</label>
                  <textarea id="hs-about-contacts-1" name="hs-about-contacts-1" rows="4" class="py-3 px-4 block mb-2 w-full outline-none border-2 border-[#264143] shadow-[3px_4px_0px_1px_#E99F4C]  rounded-md text-sm focus:translate-y-1 focus:shadow-[1px_2px_0px_0px_#E99F4C] " placeholder="Details"></textarea>
                </div>
              </div>
              <!-- End Grid -->
