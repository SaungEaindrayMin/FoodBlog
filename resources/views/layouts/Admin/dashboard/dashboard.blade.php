...
<nav class="bg-[#FFFFF0] border-b border-slate-300 fixed top-0 z-10 w-full">
    <div class="flex justify-between items-center py-4 px-6">
      ...
      <div class="nav-right flex items-center gap-4">
                ...
                <!-- End Search Input -->
                <img src="
                https://images.unsplash.com/photo-1522075469751-3a6694fb2f61?w=900&auto=format&fit=crop&q=60&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxzZWFyY2h8M3x8cHJvZmlsZXxlbnwwfHwwfHx8MA%3D%3D" alt="" class="w-8 h-8 rounded-full">
      </div>
    </div>
  </nav>


  <aside class="h-screen gird grid-cols-6 text-black ">

    {{-- side bar  --}}

    <div class=" relative hidden md:block col-start-1  col-end-2">
        <div class="fixed left-0 px-8 bg-[#FFFFF0]   h-screen  flex flex-col justify-center items-center  border-r border-slate-300 ">
          {{-- Sidebar Menu --}}
      ...
      <div class="absolute bottom-0 p-2 bg-red-600 w-full text-white text-center">
        <button>
            Log Out
        </button>
      </div>
