...
<div class="ms-0 md:ms-56">
    <div class="p-3">
        <div class="flex justify-between items-center mb-6">
            ...
            <a href="{{ route('managecategory') }}" class="flex gap-x-2 bg-[#FFFFF0] p-2 rounded-lg shadow-lg text-sm">
        ...
        <div class="bg-white rounded-lg shadow-lg p-6">
            <form action="{{ route('category.store') }}" method="POST" class="space-y-6">
                ...
                <div class="flex justify-end gap-x-3">
                    <a href="{{ route('managecategory') }}" class="px-4 py-2 border border-gray-300 rounded-md text-sm font-medium text-gray-700 hover:bg-gray-50">
                        Cancel
                    </a>
