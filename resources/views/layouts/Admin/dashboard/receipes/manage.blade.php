...
<div class="ms-0 md:ms-56 ">
    <div class="p-3 space-y-8">
        ...
        <div class="flex justify-between items-center">
            <h1 class="text-3xl font-semibold">Manage Recipes</h1>

            <div class="flex gap-x-3">
                <form action="{{ route('managerecipe') }}" method="GET" class="relative border border-slate-400 rounded-lg">
                    ...
                    <input type="text" name="search" value="{{ $searchTerm }}" class="py-2 ps-10 pe-16 block w-full bg-white border-slate-200 rounded-lg text-sm focus:outline-none" placeholder="Search by title or ingredient">
