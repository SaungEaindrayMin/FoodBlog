    ...
    <div>
        <h1 class="text-4xl font-semibold text-yellow-500">Add New Admin</h1>
            ...
            <form method="POST" action="{{route('store')}}">
              ...
              <div class="text-center mt-5">
                <div class="mt-6 grid">
                  <button type="submit" name="save" class="bg-yellow-400 mx-auto shadow-[3px_3px_0px_0px_#E99F4C] text-black font-extrabold w-72 p-4 rounded-xl hover:opacity-90">Add New Admin</button>
                </div>
            </div>
